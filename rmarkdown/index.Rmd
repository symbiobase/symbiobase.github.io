...
::: center-align
<img src="logo/logo800.png" width="800"/>
:::
...
Symbiobase will provide an open access, streamlined species identification key to unify the taxonomy of Symbiodiniaceae via access to a curated sample database and associated ITS2 rDNA repeats. Our extensive sample collection of high-latitude reefs extends south to the worlds southernmost coral reef, Lord Howe Island, and has led to the discovery of 17 new Cladocopium genotypes (Sampayo in prep).
